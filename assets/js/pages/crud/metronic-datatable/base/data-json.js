...
var KTDatatableJsonRemoteDemo= {
    init:function() {
        ...
        t=$(".kt-datatable").KTDatatable( {
            data: {
                type: "remote", source: "https://keenthemes.com/metronic/tools/preview/api/datatables/datasource/default.json", pageSize: 10
            }
            , layout: {
                scroll: !1, footer: !1
            }
            ...
            , columns:[ {
                field:"RecordID", title:"#", sortable:!1, width:20, type:"number", selector: {
            ...
            , {
                field:"Actions", title:"Actions", sortable:!1, width:110, autoHide:!1, overflow:"visible", template:function() {
